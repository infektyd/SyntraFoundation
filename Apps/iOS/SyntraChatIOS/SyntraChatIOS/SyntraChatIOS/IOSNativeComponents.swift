    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack(alignment: .bottom, spacing: 12) {
                // Multi-line text input with iOS-native behavior
                TextField("Message SYNTRA...", text: $text, axis: .vertical)
                ...
                // Send button with iOS-native styling
                Button(action: onSend) {
                    if isLoading {
                        ...
                        Image(systemName: "arrow.up.circle.fill")
                            ...
                            .background(Circle().fill(canSend ? Color.blue : Color.gray))
                    }
                }
