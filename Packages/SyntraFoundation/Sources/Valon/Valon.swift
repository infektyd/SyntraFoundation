...
public struct Valon: Sendable {
    ...
    private let emotionalSymbols: [String: SymbolicData] = [
        "danger": .init(emotion: "protective_alert", symbol: "⚠️", moral_weight: 0.9, action_bias: "caution"),
        "suffering": .init(emotion: "empathetic_concern", symbol: "💔", moral_weight: 0.95, action_bias: "help"),
        "creation": .init(emotion: "inspired_wonder", symbol: "✨", moral_weight: 0.7, action_bias: "nurture"),
        "learning": .init(emotion: "curious_growth", symbol: "🌱", moral_weight: 0.8, action_bias: "explore"),
        "problem": .init(emotion: "determined_focus", symbol: "🔍", moral_weight: 0.6, action_bias: "solve"),
        "beauty": .init(emotion: "aesthetic_appreciation", symbol: "🎨", moral_weight: 0.5, action_bias: "cherish"),
        "truth": .init(emotion: "reverent_clarity", symbol: "💎", moral_weight: 0.85, action_bias: "honor"),
        "connection": .init(emotion: "warm_belonging", symbol: "🤝", moral_weight: 0.75, action_bias: "bond")
    ]
